...
/*   Updated: 2020/08/03 16:47:46 by armajchr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void        get_items_cnt(t_visu *v, t_cw *cw, int i)
{
    ...
    v->arena_pos[i].x = (i > 0) ? v->arena_pos[i - 1].x + 15 : v->arena_rect.x + 100;
    v->arena_pos[i].x = (i % 128 == 0) ? v->arena_rect.x + 100 : v->arena_pos[i - 1].x + 15;
